...
def setup() -> dict[
    Literal["capsule_or_pipeline_id", "process_name", "create_data_assets_from_results", "rerun_all_jobs", 
            "is_pipeline", "rerun_errored_jobs", "overwrite_existing_assets"],
    str | bool | None,
]:
    args = parse_args()
    kwargs = vars(args)
